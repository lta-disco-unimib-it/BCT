...
//			------------------ begin user-written fragment code ----------------
			try{
				//System.out.println("#"+Thread.currentThread().getId()+"#"+"CALLEXIT"+bctLP85.class);
...
//			------------------- end user-written fragment code -----------------
		...
		public static void _beforeCall (
			...
			try{
				//System.out.println("#"+Thread.currentThread().getId()+"#"+"CALLENTER"+bctLP85.class);
				ComponentCallStack s = ComponentCallStack.getInstance();
				s.push( bctLP85.Probe_0.class );
	...
	public static class Probe_1 {
		...
		public static void _exit (
			...
			try{
				...
				if ( bctLP85.Probe_1.class == s.lastElement() ){
