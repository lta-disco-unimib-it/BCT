...
//			------------------ begin user-written fragment code ----------------
			try{
				//System.out.println("#"+Thread.currentThread().getId()+"#"+"CALLEXIT"+bctLP31.class);
...
//			------------------- end user-written fragment code -----------------
		...
		public static void _beforeCall (
			...
			try{
				//System.out.println("#"+Thread.currentThread().getId()+"#"+"CALLENTER"+bctLP31.class);
				ComponentCallStack s = ComponentCallStack.getInstance();
				s.push( bctLP31.Probe_0.class );
	...
	public static class Probe_1 {
		...
		public static void _exit (
			...
			try{
				...
				if ( bctLP31.Probe_1.class == s.lastElement() ){
