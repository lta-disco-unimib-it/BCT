...
//			------------------ begin user-written fragment code ----------------
			try{
				...
				LoggerProbe.exitMeta(className,methodName,methodSig,args,returnedObject,"",thisObject);
...
//			------------------- end user-written fragment code -----------------
		...
		public static void _beforeCall (
			...
			try{
				...
				LoggerProbe.enterMeta(className,methodName,methodSig,args,"",thisObject);
			} catch ( Throwable e ){
				System.err.println("BCT COMPONENT LOGGER ERROR/EXCEPTION: "+e.getMessage());
				e.printStackTrace();
			}
