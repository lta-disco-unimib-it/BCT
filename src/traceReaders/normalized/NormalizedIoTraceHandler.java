...
public interface NormalizedIoTraceHandler {
	 ...
	 */
	public abstract void saveTrace(NormalizedIoTrace normalizedTrace, DaikonComparisonCriterion comparisonCriterion ) throws TraceException;

	/**
	 * Saves data about a porgram point
	 * @param programPointData
	 */
	public abstract void addProgramPointData( ProgramPointDataStructures programPointData);

	/**
	 * Returns the structure associated to a given porgram point
