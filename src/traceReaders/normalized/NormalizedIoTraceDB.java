...
public class NormalizedIoTraceDB implements NormalizedIoTrace {
	 ...
	 * */
	public NormalizedIoTraceDB(IoTrace trace, File tracesFile, File declsFile ) {
	...
	private void writeDeclarations(DaikonComparisonCriterion comparisonCriterion) throws TraceException {
		...
		try {
			DaikonDeclarationMaker.write(declFile, entrySuperstructure, exitSuperstructure, comparisonCriterion );
			DaikonDeclarationMaker.write(writerDeclDB, entrySuperstructure, exitSuperstructure, comparisonCriterion );
		} catch (IOException e) {
			// TODO Auto-generated catch block
	...
	@Override
	public void addGenericPoint(String genericPoint,
