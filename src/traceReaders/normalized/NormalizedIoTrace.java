...
public interface NormalizedIoTrace {
	...
	/**
	 * Add a generic program point
	 * 
	 * @param genericPoint
	 * @param normalizedPoint
	 */
	public void addGenericPoint( String genericPoint, Vector<Variable> normalizedPoint);
	 ...
	 * 
	 * @param comparisonCriterion the criterion used to generate daikon declaration files
	 * 
