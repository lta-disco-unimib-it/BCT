...
public class DBDataRecorder implements DataRecorder {
	...
	public void recordIoInteractionEnterMeta(Object calledObject, String methodSignature, Handler[] parametersHandlers, long threadId, String metaInfo) throws RecorderException {
		recordInteraction(methodSignature, "B#", threadId);
		recordIoMeta( ":::ENTER", methodSignature, parametersHandlers, null, false, metaInfo );
	}

	public void recordIoInteractionExitMeta(Object calledObject, String methodSignature, Handler[] parametersHandlers, long threadId, String metaInfo) throws RecorderException {
		recordInteraction(methodSignature, "E#", threadId);
		recordIoMeta( ":::EXIT1", methodSignature, parametersHandlers, null, false, metaInfo );
	}

	public void recordIoInteractionExitMeta(Object calledObject, String methodSignature, Handler[] parametersHandlers, Handler returnValueHandler, long threadId, String metaInfo) throws RecorderException {
		recordInteraction(methodSignature, "E#", threadId);
	...
	public void recordGenericProgramPoint(String programPointName,
		...
		//TODO: should be similar to IOinteractionENter
	}
