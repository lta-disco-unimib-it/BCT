...
/**
 * This recorders keep track of violations by writing them in plain text file.
 * 
...
public class FileViolationsRecorder implements ViolationsRecorder {
	...
	static void recordParameters(PrintWriter pw, Object[] argumentValues ) {
	...
	static void recordReturnvalue(PrintWriter pw, Object returnValue ) {
	...
	public void recordAnomalousCallSequence(String invokingMethod,
	...
	public void recordAnomalousCallSequence(int callId, String correspondingMethod,
