...
public class FieldNameCondition extends FieldCondition {
	...
	public FieldNameCondition(){};
	
	public FieldNameCondition(boolean accept, String packageCondition, String classCondition, String fieldCondition) {
		super(accept);
	...
	public void setPackageRegexp(String packageRegexp) {
		this.packageRegexp = packageRegexp;
	}

	public void setClassRegexp(String classRegexp) {
