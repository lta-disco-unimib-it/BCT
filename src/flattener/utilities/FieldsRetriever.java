...
public abstract class FieldsRetriever {
	...
	/**
	 * This IdManager returns all declared fields whit a getter associated.
	 *  
	 * @author Fabrizio Pastore fabrizio.pastore AT gmail.com
	 *
	 */
	...
	public static class FieldsRetrieverInstanceFields extends FieldsRetriever {

		public FieldsRetrieverInstanceFields(FieldFilter fieldsFilter) {
			super(fieldsFilter);
		}
	 ...
	 * 
	 * Synchronization over IdManager itself could causeperformance problem on multi threaded programs.
	 * 
