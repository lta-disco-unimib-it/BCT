...
public class ClassFormatter {
	...
	public static String getMethodFromFullJavaSignature( String methodFullSignature ){
		...
		String method = methodFullSignature.substring(0, parStart);
		
		return method;
	}
	
	public static String getClassFromFullJavaSignature( String methodFullSignature ){
		

		String method = getMethodFromFullJavaSignature(methodFullSignature);
		
		int par = method.lastIndexOf('.');
		
		if ( par < 0 ){
			return null;
		}
		
		return method.substring(0,par);
	}
