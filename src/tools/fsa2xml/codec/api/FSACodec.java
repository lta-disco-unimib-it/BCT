...
public interface FSACodec{
    ...
    /**
	 * Load an FSA from the file stored in the given path, and transform transition labels by replacing
	 * the prefix of the labels with the corresponding value in the map, when the prefix is equal to
	 * the a key in the map.
	 * 
	 * 
	 * @param filename path of the file
	 * @return
	 ...
	 * @throws ClassNotFoundException
	 */
    public FiniteStateAutomaton loadFSA(String filename, Map<String,String> namesMapping) throws IOException, ClassNotFoundException;
