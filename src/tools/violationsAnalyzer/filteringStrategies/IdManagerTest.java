...
public class IdManagerTest implements IdManager{

	public static final IdManager INSTANCE = new IdManagerTest();
	
	private IdManagerTest(){};
	...
	public Set<String> getCorrectIds(FailuresManager failureManager) {
		return failureManager.getCorrectTests();
	}

	public Set<String> getFailingIds(FailuresManager failureManager) {
		return failureManager.getFailingTests();
	}
