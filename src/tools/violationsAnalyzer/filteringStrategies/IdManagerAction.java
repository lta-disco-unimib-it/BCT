...
public class IdManagerAction implements IdManager{

	public static final IdManager INSTANCE = new IdManagerAction();

	
	private IdManagerAction(){
	...
	public Set<String> getCorrectIds(FailuresManager failureManager) {
		return failureManager.getCorrectActions();
	}

	public Set<String> getFailingIds(FailuresManager failureManager) {
		return failureManager.getFailingActions();
	}
