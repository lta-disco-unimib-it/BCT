...
/**
 * ExecutionContextRegistry is a generic interface for classes that implement functionalities to maintain information about current execution context
 * @author Fabrizio Pastore fabrizio.pastore AT gmail.com
 *
 * @param <T>
 */
public interface ExecutionContextRegistry <T extends ExecutionContextData>{
