...
public class ArrayIndexAssembler extends Assembler {
  ...
  public void workOn(Assembly a) {
      ...
      if(targetArray instanceof LocalVariablesWrapper) {  
    	  LocalVariablesWrapper localW = (LocalVariablesWrapper) targetArray;
    	  target.push( target.getLocalVariable( localW.getVariableName()+"["+arrayIndex+"]" ) );
    	  return;
      }
