  ...
  public void workOn(Assembly a) {	  
    ...
    */
    ...
    if ( parameter1 == null || parameter2 == null ){
    	target.push(Boolean.TRUE); //Daikon discard null values when doing comparisons
    }
    
    if (parameter1 instanceof LocalVariablesWrapper || parameter2 instanceof LocalVariablesWrapper){
    ...
    else if (parameter1 instanceof LocalVariablesWrapper && parameter2 instanceof LocalVariablesWrapper){
        target.push(Boolean.TRUE);
        target.block();
    } else 
		target.block();
