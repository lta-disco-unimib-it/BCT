...
public class IoInvariantParserOffline  {
	...
	private static Parser localVariable(){
		...
		Alternation starsAndRefs = new Alternation();
		
		Repetition stars = new Repetition(new Symbol('*').setAssembler(new StarAssembler()));
		
		
//		Parser singleStar = new Symbol('*').setAssembler(new StarAssembler());
		Parser ref = new Symbol('&').setAssembler(new RefAssembler());
		
		starsAndRefs.add(stars);
		starsAndRefs.add(ref);
