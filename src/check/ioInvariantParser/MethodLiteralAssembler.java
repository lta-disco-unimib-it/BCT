...
public class MethodLiteralAssembler extends Assembler  {
  ...
  public void workOn(Assembly a) {
    ...
    if ( targetObject instanceof LocalVariablesWrapper ){
  	  LocalVariablesWrapper targetObjectWrapper = (LocalVariablesWrapper) targetObject;
  	  LocalVariablesWrapperUtil.handle( target, targetObjectWrapper, methodName );
  	  return;
    }
    ...
    if (targetObject==null) {
    	target.push(new NonExistentVariable(Types.METHOD,methodName));
    	target.block();
