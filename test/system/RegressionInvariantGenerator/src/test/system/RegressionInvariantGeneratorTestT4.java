...
public class RegressionInvariantGeneratorTestT4 extends TestCase {

	public void testT4() throws IOException{
		
		RegressionInvariantGeneratorTest.setTestHome("T4");
		...
		assertTrue(RegressionInvariantGeneratorTest.vectorsEqual(new boolean[]{false,true,false,false},vector));
		
		vector = it.next();
		assertTrue(RegressionInvariantGeneratorTest.vectorsEqual(new boolean[]{false,false,true,true},vector));
		
		vector = it.next();
		assertTrue(RegressionInvariantGeneratorTest.vectorsEqual(new boolean[]{true,true,false,true},vector));
		...
		RegressionInvariantGeneratorUtil.clean("T4");
	}
}
