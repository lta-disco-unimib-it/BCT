 ...
 *
 */
public class MatchingRuleExcludeTest {
	...
	@Test
	public void test1() {
		MatchingRuleExclude rule = new MatchingRuleExclude("org.apache.catalina.core","C.*","m.*");
		
		assertTrue(rule.rejectMethod("org.apache.catalina.core", "Clazz", "meth(()V)"));
		assertFalse(rule.acceptMethod("org.apache.catalina.core", "Clazz", "meth(()V)"));
		...
		assertTrue(rule.rejectClass("org.apache.catalina.core", "Clazz") );
		assertFalse(rule.acceptClass("org.apache.catalina.core", "Clazz") );
	...
	@Test
	public void test2() {
		MatchingRuleExclude rule = new MatchingRuleExclude("org.apache.catalina.core.*","Clazz","m.*");
		
		assertTrue(rule.rejectMethod("org.apache.catalina.core.u", "Clazz", "meth(()V)"));
		assertFalse(rule.acceptMethod("org.apache.catalina.core.u", "Clazz", "meth(()V)"));
	...
	@Test
	public void test3() {
		MatchingRuleExclude rule = new MatchingRuleExclude("org.apache.catalina.core.*","Clazz.*","meth\\(\\(\\)V\\)");
		...
		assertTrue(rule.rejectClass("org.apache.catalina.core", "Clazze") );
		assertFalse(rule.acceptClass("org.apache.catalina.core", "Clazze") );
	...
	@Test
	public void test4() {
		MatchingRuleExclude rule = new MatchingRuleExclude("org.apache.catalina.core.*","Clazz.*","met.*");
		
		assertTrue(rule.rejectMethod("org.apache.catalina.core.u", "Clazz", "meth(()V)"));
		assertFalse(rule.acceptMethod("org.apache.catalina.core.u", "Clazz", "meth(()V)"));
		
		assertTrue(rule.rejectMethod("org.apache.catalina.core", "Clazzes", "meth(()V)"));
		assertFalse(rule.acceptMethod("org.apache.catalina.core", "Clazzes", "meth(()V)"));
		
		assertTrue(rule.rejectMethod("org.apache.catalina.core", "Clazzes", "method((II)V)"));
		assertFalse(rule.acceptMethod("org.apache.catalina.core", "Clazzes", "method((II)V)"));
