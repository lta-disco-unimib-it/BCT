...
public class LessOrEqualThanAssemblerTest extends AssemblerTestCase {

	public LessOrEqualThanAssemblerTest(String name) {
		super(name);
	}
	...
	public void testVarLTEVar() throws InvariantParseException{
		
		ArrayList result = IoInvariantParser.getTestCaseSpecifications( parameter0+" <= "+parameter1, programPointEnter);
		
		assertEquals( 3, result.size() );
		
		assertTrue ( result.contains( new TcSpecificationEquals( var1, var0Enter ) ) );
	...
	public void testVarLTEInt() throws InvariantParseException{
