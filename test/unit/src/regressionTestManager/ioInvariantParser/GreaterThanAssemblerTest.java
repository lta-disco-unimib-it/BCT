...
public class GreaterThanAssemblerTest extends AssemblerTestCase {

	public GreaterThanAssemblerTest(String name) {
		super(name);
	}
	...
	public void testVarGTVar() throws InvariantParseException{
	...
	public void testVarGTInt() throws InvariantParseException{
