...
import dfmaker.utilities.IoTraceCreatorCyclic;

public class IoTraceCreatorSimple extends IoTraceCreatorCyclic {
	...
	public IoTraceCreatorSimple(String methodName,int iterations) {
		...
		bExit.append("6\n");
		bExit.append("1\n");
		bExit.append("returnValue.intValue()\n");
		bExit.append("6\n");
		bExit.append("1\n");
