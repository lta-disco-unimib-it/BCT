  ...
  public void workOn(Assembly a) {
      ...
      //Token arrayIndexToken = (Token)a.pop();
		  ...
		  try{
			  ...
			  String indexString;
			  if ( arrayIndexToken.isNumber() ){
				  indexString = Integer.toString((int) arrayIndexToken.nval());
			  } else {
				  indexString = arrayIndexToken.sval();
			  }

			  String arrayName = target.pop().toString();
			  target.push(arrayName+"["+indexString+"]");
