...
public class IoInvariantParser  {
	...
	private static Parser pointerDereference() {

		DerefOperatorAssembler derefOperatorAssembler = new DerefOperatorAssembler();
		DerefAssembler derefAssembler = new DerefAssembler(derefOperatorAssembler);

		Parser p = new Sequence()
		.add(new Symbol('*').setAssembler(derefOperatorAssembler))
		.add(new Word().setAssembler(derefAssembler));

		//	  .setAssembler(new WordAssembler());
		return p;
	...
	private static Assembly createTokenAssembly(String expression ) {
	...
	public static String evaluateExpression(String expression) throws InvariantParseException {
		//System.out.println("evaluateExpression: "+expression);  

		//System.out.println(expression);
		try {
			Parser p = invariantParser();
			Assembly a = createTokenAssembly(expression);      
			...
			if(result==null)
				...
				try{
					...
					return (String) resultingTarget.pop();
