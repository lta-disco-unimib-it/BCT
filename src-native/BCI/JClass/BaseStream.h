 ...
 * $Id: BaseStream.h,v 1.1.2.2 2006-12-02 12:41:42 pastore Exp $ 
 * 
 * Contributors: 
...
public:
	...
	virtual void ReadUtf8(void* i_pbuffer, long i_size) = 0;
	virtual void WriteUtf8(void* i_pdata, long i_size) = 0;
