...
public class BctTCIntegratedLA23 {
  ...
  public static class Exec {
	  ...
	  public void logEntry(final JoinPoint joinPoint) {
		  ...
		  try {	
			  ...
			  if ( BctTCIntegratedLA23.Exec.class == s.lastElement() ){
				  s.push( BctTCIntegratedLA23.Exec.class );
				  //System.out.println("ENTER#"+BctLA0.Exec.class.getName()+" "+getSignature(joinPoint));
				  return;
			  }
	  ...
	  public void logExit(final JoinPoint joinPoint) {
		  ...
		  try {
			  ComponentCallStack s = ComponentCallStack.getInstance();
			  if ( s.lastElement() != BctTCIntegratedLA23.Exec.class )
				  System.out.println("POPERROR "+BctTCIntegratedLA23.Exec.class.getName()+" "+getSignature(joinPoint));
  ...
  public static class Call {
	  ...
	  public void logEntry(final JoinPoint joinPoint) {
		  ...
		  try {	
			  ComponentCallStack s = ComponentCallStack.getInstance();
			  s.push( BctTCIntegratedLA23.Call.class );
			  logIOInteraction(joinPoint, ENTER);
