...
public class BctTCIntegratedLA99 {
  ...
  public static class Exec {
	  ...
	  public void logEntry(final JoinPoint joinPoint) {
		  ...
		  try {	
			  ...
			  if ( BctTCIntegratedLA99.Exec.class == s.lastElement() ){
				  s.push( BctTCIntegratedLA99.Exec.class );
				  //System.out.println("ENTER#"+BctLA0.Exec.class.getName()+" "+getSignature(joinPoint));
				  return;
			  }
	  ...
	  public void logExit(final JoinPoint joinPoint) {
		  ...
		  try {
			  ComponentCallStack s = ComponentCallStack.getInstance();
			  if ( s.lastElement() != BctTCIntegratedLA99.Exec.class )
				  System.out.println("POPERROR "+BctTCIntegratedLA99.Exec.class.getName()+" "+getSignature(joinPoint));
  ...
  public static class Call {
	  ...
	  public void logEntry(final JoinPoint joinPoint) {
		  ...
		  try {	
			  ComponentCallStack s = ComponentCallStack.getInstance();
			  s.push( BctTCIntegratedLA99.Call.class );
			  logIOInteraction(joinPoint, ENTER);
