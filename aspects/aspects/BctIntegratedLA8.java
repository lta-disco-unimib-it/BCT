...
public class BctIntegratedLA8 {
  ...
  public static class Exec {
	  ...
	  public void logEntry(final JoinPoint joinPoint) {
		  ...
		  try {	
			  ...
			  if ( BctIntegratedLA8.Exec.class == s.lastElement() ){
				  s.push( BctIntegratedLA8.Exec.class );
				  //System.out.println("ENTER#"+BctLA0.Exec.class.getName()+" "+getSignature(joinPoint));
				  return;
			  }
			  s.push( BctIntegratedLA8.Exec.class );
	  ...
	  public void logExit(final JoinPoint joinPoint) {
		  ...
		  try {
			  ComponentCallStack s = ComponentCallStack.getInstance();
			  if ( s.lastElement() != BctIntegratedLA8.Exec.class )
				  System.out.println("POPERROR "+BctIntegratedLA8.Exec.class.getName()+" "+getSignature(joinPoint));
  ...
  public static class Call {
	  ...
	  public void logEntry(final JoinPoint joinPoint) {
		  ...
		  try {	
			  ComponentCallStack s = ComponentCallStack.getInstance();
			  s.push( BctIntegratedLA8.Call.class );
			  logIOInteraction(joinPoint, ENTER);
