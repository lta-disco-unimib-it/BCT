...
public class BctTCIntegratedLA63 {
  ...
  public static class Exec {
	  ...
	  public void logEntry(final JoinPoint joinPoint) {
		  ...
		  try {	
			  ...
			  if ( BctTCIntegratedLA63.Exec.class == s.lastElement() ){
				  s.push( BctTCIntegratedLA63.Exec.class );
				  //System.out.println("ENTER#"+BctLA0.Exec.class.getName()+" "+getSignature(joinPoint));
				  return;
			  }
	  ...
	  public void logExit(final JoinPoint joinPoint) {
		  ...
		  try {
			  ComponentCallStack s = ComponentCallStack.getInstance();
			  if ( s.lastElement() != BctTCIntegratedLA63.Exec.class )
				  System.out.println("POPERROR "+BctTCIntegratedLA63.Exec.class.getName()+" "+getSignature(joinPoint));
  ...
  public static class Call {
	  ...
	  public void logEntry(final JoinPoint joinPoint) {
		  ...
		  try {	
			  ComponentCallStack s = ComponentCallStack.getInstance();
			  s.push( BctTCIntegratedLA63.Call.class );
			  logIOInteraction(joinPoint, ENTER);
